...
fn main() {
    ...
    match mode.as_str() {
        ...
        "vertex" => label_propagation(&NodesEdgesMemMapper::new(&name), nodes),
        "hilbert" => label_propagation(&UpperLowerMemMapper::new(&name), nodes),
        "compressed" => label_propagation(
